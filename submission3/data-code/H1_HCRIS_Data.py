...
# Notes: Python file to build HCRIS data for Econ 470 Hwk 2

import pandas as pd
import numpy as np

# Read and combine data ---------------------------------------------------
final_hcris_v1996 = pd.read_csv('/Users/ellenwu/econ470/Homework2/data/data/output/HCRIS_v1996.csv')
final_hcris_v2010 = pd.read_csv('/Users/ellenwu/econ470/Homework2/data/data/output/HCRIS_v2010.csv')
...
# Save final data ---------------------------------------------------------
final_hcris_data.to_csv('/Users/ellenwu/econ470/Homework2/data/data/output/HCRIS_Data.csv', index=False)