...
for year in range(2010, 2019):
    ...
    alpha_path = f"/Users/ellenwu/econ470/Homework2/data/data/input/HCRIS_v2010/HospitalFY{year}/hosp10_{year}_ALPHA.CSV"
    numeric_path = f"/Users/ellenwu/econ470/Homework2/data/data/input/HCRIS_v2010/HospitalFY{year}/hosp10_{year}_NMRC.CSV"
    report_path = f"/Users/ellenwu/econ470/Homework2/data/data/input/HCRIS_v2010/HospitalFY{year}/hosp10_{year}_RPT.CSV"
...
final_hcris_v2010.to_csv("/Users/ellenwu/econ470/Homework2/data/data/output/HCRIS_v2010.csv", index=False)